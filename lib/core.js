let
  ...
  Dsl = require('./api/dsl'),
  EntryPoints = require('./api/core/entryPoints'),
  FunnelController = require('./api/controllers/funnelController'),
  HotelClerk = require('./api/core/hotelClerk'),
  IndexCache = require('./api/core/indexCache'),
  InternalEngine = require('./services/internalEngine'),
  GarbageCollector = require('./services/garbageCollector'),
  Notifier = require('./api/core/notifier'),
  PassportWrapper = require('./api/core/auth/passportWrapper'),
  PluginsManager = require('./api/core/plugins/pluginsManager'),
  Promise = require('bluebird'),
  Cli = require('./api/cli'),
  CliController = require('./api/controllers/cliController'),
  Repositories = require('./api/core/models/repositories'),
  RouterController = require('./api/controllers/routerController'),
  Services = require('./services'),
  Statistics = require('./api/core/statistics'),
  TokenManager = require('./api/core/auth/tokenManager'),
  Validation = require('./api/core/validation'),
 ...
 * @constructor
 */
function Kuzzle (rootPath, customConfiguration = {}) {
  /** @type {KuzzleConfiguration} */
  this.config = defaultsDeep(customConfiguration, require('./config'));
